package hu.bme.aut.android.householder
...
import hu.bme.aut.android.householder.extensions.validateNonEmpty
        ...
        firebaseAuth.createUserWithEmailAndPassword(etEmail.text.toString(), etPassword.text.toString())
            .addOnSuccessListener{result ->
                ...
                val profileChangeRequest = UserProfileChangeRequest.Builder()
                    .setDisplayName(firebaseUser?.email?.substringBefore('@')).build()
